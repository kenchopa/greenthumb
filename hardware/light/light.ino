...
// INPUT PINS
const int INPUT_PIN_LDR_SENSOR = A0;
...
// VARS
const int NUM_STATES = 6; // the number of states
const String states[NUM_STATES] = {"dark", "low light", "moderate light", "bright light", "very bright light", "unknown"}; // the string values for each state
...
void loop() {
  ...
  // INIT DATA
  int analogValue = analogRead(INPUT_PIN_LDR_SENSOR);
